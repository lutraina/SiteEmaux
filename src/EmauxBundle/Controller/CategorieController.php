...
use EmauxBundle\Entity\Categorie;
use EmauxBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('EmauxBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EmauxBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('EmauxBundle\Form\CategorieType', $categorie);
